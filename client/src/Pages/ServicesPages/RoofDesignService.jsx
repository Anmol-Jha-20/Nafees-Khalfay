...
function RoofDesignService() {
  ...
  const products = [
    {
      id: 1,
      name: "Space Frame Design",
      images: [
        "https://5.imimg.com/data5/SELLER/Default/2024/7/436930133/VW/BG/GG/2478166/space-frame-design-500x500.png",
      ],
      description:
    ...
    },
    {
      ...
      images: [
        "https://5.imimg.com/data5/SELLER/Default/2024/7/436929004/HY/LG/YI/2478166/steel-detailing-500x500.png",
      ],
      description:
      ...
      <div className="min-h-screen bg-white">
        <section className="relative h-96 bg-gradient-to-r from-gray-900 to-gray-700 overflow-hidden">
          ...
          <div
            ...
            style={{
              backgroundImage: `url("https://img.freepik.com/free-photo/medium-shot-man-working-roof_23-2149343643.jpg?t=st=1757501441~exp=1757505041~hmac=0b35fa3089232b83d6d2496e19109ae0cc3b3b88ab1c29ff3afd7d32e91b6b8c&w=1060")`,
            }}
          ></div>
          ...
          <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center">
            ...
            >
              ...
              >
                ...
                <span className="text-yellow-400">Roof Design Services</span>
              </motion.nav>
            </motion.div>
          </div>
        </section>
              ...
              >
                ...
                <p className="text-xl lg:text-2xl mb-8 text-blue-100">
                  <span className="block font-semibold text-yellow-400">
                    Expert Roof Design & Steel Detailing Solutions Tailored to
                    Your Structural Needs
                  </span>
                </p>

                <p className="text-lg mb-8 leading-relaxed text-gray-600">
                  As prominent and leading consultants based in Mumbai, we
                  specialize in delivering high-quality Roof Design Services,
                  including Space Frame Design and Steel Detailing. Our
                  solutions are tailored to meet the structural, aesthetic, and
                  functional requirements of industrial, commercial, and
          ...
          <div className="container mx-auto">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-black">
                Our&nbsp;
                <span>Roof Design Services</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Prominent & Leading Consultants from Mumbai, we offer Space
                Frame Design, Roof Design Services and Steel Detailing.
              </p>
            </div>
...
export default RoofDesignService;
