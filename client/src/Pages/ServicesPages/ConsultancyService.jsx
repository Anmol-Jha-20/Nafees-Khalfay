...
function ConsultancyService() {
  ...
  const products = [
    {
      id: 1,
      name: "Engineering Consultant Service",
    ...
    {
      id: 3,
      name: "Roofing Design Service",
      images: [
        "https://img.freepik.com/free-photo/medium-shot-man-working-roof_23-2149343643.jpg?t=st=1757501441~exp=1757505041~hmac=0b35fa3089232b83d6d2496e19109ae0cc3b3b88ab1c29ff3afd7d32e91b6b8c&w=1060",
      ],
      description:
          ...
          <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center">
            ...
            >
              ...
              >
                ...
                <span className="text-yellow-400">Consultancy Services</span>
              </motion.nav>
            </motion.div>
          </div>
        </section>
              ...
              >
                ...
                <p className="text-xl lg:text-2xl mb-8 text-blue-100">
                  <span className="block font-semibold text-yellow-400">
                    Innovative Engineering & Design Consultancy Tailored to Your
                    Project Needs
                  </span>
                </p>

                <p className="text-lg mb-8 leading-relaxed text-gray-600">
                  We are pioneers in providing specialized Consultancy Services
                  in the field of engineering and structural design. Our
                  offerings include Engineering Consultant Services, Shed
                  Designing Services, and Roofing Design Services, all tailored
                  to meet the unique needs of each project. With a focus on
                  quality, innovation, and compliance with industry standards,
                  we deliver reliable and cost-effective solutions to clients
          ...
          <div className="container mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Pioneers in the industry, we offer Engineering Consultant
                Service, Shed Designing Service and Roofing Design Service from
                India.
              </p>
            </div>
