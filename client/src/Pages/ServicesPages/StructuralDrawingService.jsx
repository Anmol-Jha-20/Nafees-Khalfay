...
function StructuralDrawingService() {
  const fadeInUp = {
      ...
      <div className="min-h-screen bg-white">
        <section className="relative h-96 bg-gradient-to-r from-gray-900 to-gray-700 overflow-hidden">
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${StructuralDrawingImage})`,
            }}
          ></div>
              ...
              >
                ...
                <p className="text-xl lg:text-2xl mb-8 text-blue-100">
                  <span className="block font-semibold text-yellow-400">
                    Precise Structural & Shop Drawing Solutions Delivered with
                    Accuracy and Speed
                  </span>
                </p>

                <p className="text-lg mb-8 leading-relaxed text-gray-600">
                  We provide high-quality Structural Drawing and Shop Drawing
                  Services tailored to meet the specific needs of construction
                  and engineering projects. Our drawings are prepared with
                  precision, ensuring accurate representation of structural
                  elements for safe, efficient, and code-compliant execution
                  on-site.
                </p>
          ...
          <div className="container mx-auto">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-black">
                Our&nbsp;
                <span>Structural Drawing Service</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Providing you the best range of Structural Drawing . and Shop
                Drawing Services with effective & timely delivery.
              </p>
            </div>
...
export default StructuralDrawingService;
